%   HECHOS DE LOS DEPARTAMENTOS DE COLOMBIA
...
%   PRODUCTOS QUE SE PUEDEN CULTIVAR EN UN DEPARTAMENTO
...
cultivar(nari�o, cereales).
cultivar(nari�o, frutales).
cultivar(nari�o, papa).
cultivar(nari�o, cafe).
